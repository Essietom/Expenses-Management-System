...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="index.html"><b>Expenses Manager</b></a>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <form class="lockscreen-credentials" action="login.php" method="post">
      <div class="input-group">
        <input type="text" class="form-control" name="login"  value="Username/Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Invalid Username';}"">
  ...
  <div class="lockscreen-footer text-center">
    <b>&copy 2015 Crystal EPM. Developed by <a href="https://crystalhills.org/" target="_blank">Crystall Hills</a></b><br>
    All rights reserved
  </div>
</div>
<!-- /.center -->
