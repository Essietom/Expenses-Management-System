...
<div class="content-wrapper">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#add-budget" aria-controls="add-budget" role="tab" data-toggle="tab">Add Income Budget</a></li>
      ...
      <div class="row">
        ...
        <div class="clearfix"> </div>
               ...
               <div class="form-group">
                  ...
                  <label for="selector1" class="col-sm-2 control-label">Expected Income</label>
                  <div class="col-sm-10">
                    <input type="text" name="expectedincome" required placeholder="Enter Expected Income" class="form-control" value="<?php echo !empty($expectedincome)? $expectedincome:'';?>">
                  </div>
        ...
        <div class="clearfix"> </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary" name="income">Add</button>
              </div>
              <!-- /.box-footer -->
      ...
      <div class="row">
           ...
           <div class="box box-info blue-border">
            ...
            <form role="form"   class="form-inline" id="create">
              ...
              <button id="submit" class="btn btn-primary" type="submit" name="data" >View Income</button>
            </div>
            <!-- /.box-body -->
          </form>
    ...
    <div class="col-lg-12">
          <div class="box box-solid">
            <div class="box-header">
              ...
              <h3 class="box-title">Income For <?php echo $budgetyear?></h3>
              <!-- tools box -->
...
<div id="pay-report">
  <table class="table span12 table-stripped">
    ...
    <tbody>
     ...
     <?php income::incomebudget($budgetyear); ?>
